...
function CourseContent() {
  ...
  if (!course && !isLoading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-[#050816] space-y-4">
...
export default function CoursePage() {
  return (
    <Suspense fallback={<div className="flex items-center justify-center min-h-screen bg-[#050816]"><Loader2 className="h-12 w-12 animate-spin text-primary" /></div>}>
      <CourseContent />
    </Suspense>
  );
}
