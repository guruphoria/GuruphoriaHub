      ...
      <div className="container mx-auto flex h-16 sm:h-20 items-center justify-between px-6">
        <div className="flex items-center gap-6 lg:gap-10">
          <Link href="/" className="flex items-center gap-2 group" prefetch={false}>
            <div className="bg-primary/20 p-1 rounded-lg group-hover:bg-primary/30 transition-colors overflow-hidden shrink-0">
              {brandLogo ? (
                <Image 
            ...
            <span className="text-lg sm:text-xl font-headline font-bold tracking-tight uppercase hidden xs:block">Guruphoria</span>
          </Link>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <Button variant="ghost" size="icon" className="text-muted-foreground hover:text-white hidden sm:flex h-9 w-9">
            <Search className="h-4 w-4 sm:h-5 sm:w-5" />
          </Button>
          <div className="hidden md:flex items-center gap-1 border-l border-white/10 pl-2">
            <Button variant="ghost" size="icon" asChild className="text-muted-foreground hover:text-white h-9 w-9">
            ...
            <Button asChild className="bg-primary text-primary-foreground hover:bg-primary/90 rounded-full px-4 lg:px-6 h-9 font-semibold hidden lg:flex text-xs lg:text-sm">
              <Link href="https://www.youtube.com/@guruphoria" target="_blank" rel="noopener noreferrer">
                <Youtube className="mr-2 h-3.5 w-3.5 sm:h-4 sm:w-4" /> Subscribe
              </Link>
            </Button>
          </div>
              ...
              <div className="flex flex-col p-6 space-y-6 overflow-y-auto max-h-[calc(100vh-80px)]">
                <nav className="flex flex-col space-y-4">
                  {navLinks.map((link) => (
                    <Link 
                      key={link.name} 
                      href={link.href} 
                      className="text-base sm:text-lg font-medium text-muted-foreground hover:text-primary transition-colors border-b border-white/5 pb-2"
                    >
                      {link.name}
                    </Link>
                  ))}
                ...
                <div className="pt-2 space-y-4">
                  ...
                  <div className="flex gap-3">
                    <Button variant="outline" size="icon" asChild className="glass border-white/10 rounded-full h-9 w-9">
                  ...
                  <Button asChild className="w-full bg-primary hover:bg-primary/90 rounded-full font-bold h-11 text-sm">
                    <Link href="https://www.youtube.com/@guruphoria" target="_blank">
